        ...
        <header className="bg-transparent">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <a href="#" className="-m-1.5 p-1.5">
                    ...
                    <img className="h-8 w-auto" src="https://placehold.co/100" alt=""/>
                </a>
                </div>
                ...
                <a href="#" className="text-sm/6 font-semibold text-gray-900">Dummy</a>
                <a href="#" className="text-sm/6 font-semibold text-gray-900">ipsum</a>
                <a href="#" className="text-sm/6 font-semibold text-gray-900">dolor</a>
                </div>
            ...
            <div className="lg:hidden" role="dialog" aria-modal="true">
                ...
                <div className="flex items-center justify-between">
                    <a href="#" className="-m-1.5 p-1.5">
                    <span className="sr-only">Your Company</span>
                    <img className="h-8 w-auto" src="https://placehold.co/50" alt=""/>
                    </a>
